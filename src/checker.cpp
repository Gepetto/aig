...
void checkLegComputation(){
    ...
    pin::SE3 LF(data.oMf[LF_id]);
    foot.translation(LF.translation());
    foot.rotation(LF.rotation());
...
void checkPostureComputation(){
    ...
    IK_tools::legJoints leg;
    IK_tools::Chassis H;
    IK_tools::Homogeneous com, leftFoot, rightFoot;
    pin::Data data(H.model);
    ...
    pin::SE3 LF(data.oMf[LF_id]), RF(data.oMf[RF_id]);
    leftFoot.translation(LF.translation());
    leftFoot.rotation(LF.rotation());
    rightFoot.translation(RF.translation());
    rightFoot.rotation(RF.rotation());
    ...
    Eigen::VectorXd q_new = H.computePosture(com, leftFoot, rightFoot, H.q0);
