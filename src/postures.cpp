...
namespace IK_tools{
    ...
    void BipIK::solve(const xyzVector &com, const pin::SE3 &leftFoot, const pin::SE3 &rightFoot,
        ...
        //posture.segment(3, 4) = pin::quaternion::assignQuaternion(base.rotation()); //TODO check transformation to quaternions
    ...
    void BipIK::solve(const std::array<xyzVector, 3> &coms, const std::array<pin::SE3, 3> &leftFeet,
                      const std::array<pin::SE3, 3> &rightFeet, const Eigen::VectorXd &q0, const double &dt,
    ...
    void BipIK::solve(const std::array<xyzVector, 3> &coms, const std::array<RotMatrix, 3> &baseRotations,
                      ...
                      const Eigen::VectorXd &q0, const double &dt, Eigen::VectorXd &posture, 
    ...
    void BipIK::solve(const std::array<pin::SE3, 3> &bases, const std::array<pin::SE3, 3> &leftFeet, 
                      const std::array<pin::SE3, 3> &rightFeet, const Eigen::VectorXd &q0, 
                      const double &dt, Eigen::VectorXd &posture, Eigen::VectorXd &velocity, 
