...
namespace dyno {
  namespace python {
    ...
    void exposeContact6D() {
      ...
      .def("set_force_weights", Contact6D::setForceWeights, bp::args("self", "force_weights"))
      .def("set_torque_weights", Contact6D::setTorqueWeights, bp::args("self", "torque_weights"))
      .def("set_surface_half_width", Contact6D::setSurfaceHalfWidth, bp::args("self", "half_width"))
      .def("set_surface_half_length", Contact6D::setSurfaceHalfLength, bp::args("self", "half_length"))
      .def("update_NE_matrix", Contact6D::updateNewtonEuler, bp::args("self", "CoM", "oMf"))
